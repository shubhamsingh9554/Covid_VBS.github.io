...
<head>
    ...
    <title>Covid-VBS | Statewise Booking Dashboard</title>
...
<?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-left mb-4">
                        <a class="small" href="index.php" style="font-weight:bold;"><i class="fa fa-home"
                                aria-hidden="true"></i> Home Page</a>
                    </div>
                    <h1 class="h3 mb-2 text-gray-800">Statewise Booking Dashboard</h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Statewise Booking Dashboard</h6>
                        </div>
                        <div class="card-body">
