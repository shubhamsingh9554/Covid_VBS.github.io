...
<head>
    ...
    <title>Covid-VBS | Dashboard</title>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <a href="ontheway-samplecollection-test.php">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> On
                                                    the way for sample collection
                                                </div>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
