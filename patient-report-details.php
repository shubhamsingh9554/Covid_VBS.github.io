...
<head>
    ...
    <title>Covid-19 VBS | Add Medic</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Vaccination Details  <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">VaccineInformation</h6>
                                </div>
                                <div class="card-body">
