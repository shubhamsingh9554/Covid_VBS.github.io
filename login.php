...
<head>
    ...
    <title>Covid 19 Slot Booking System | Admin Login</title>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <h3 align ="center" style="margin-top:4%;color:#fff">Covid Slot Booking System</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="password-recovery.php"
                                                style="font-weight:bold">Forgot Password?</a>

                                        </div>
                                        <div class="text-center">
                                            <h1 class="small">Help to login :  <br> User : admin<br> Password : Test@123</h1>
                                        </div>
